...
class covariance(covariance_estimators):
    ...
    def __init__(self,estimator='EmpiricalCovariance',squared=False,normalise=False):
...
class spearmanr(undirected,signed):
    ...
    def __init__(self,squared=False):
        ...
        if squared:
            self.issigned = lambda : False
            self.name = self.name + '-sq'
            self.labels = spearmanr.labels + ['unsigned']
        else:
            self.labels = spearmanr.labels + ['signed']
...
class kendalltau(undirected,signed):
    ...
    def __init__(self,squared=False):
        ...
        if squared:
            self.issigned = lambda : False
            self.name = self.name + '-sq'
            self.labels = kendalltau.labels + ['unsigned']
        else:
            self.labels = kendalltau.labels + ['signed']
